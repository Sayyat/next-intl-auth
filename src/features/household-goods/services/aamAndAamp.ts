...
export const fetchBufferCapacity = async (payload: IBufferCapacityPayload): Promise<IResponse<IBufferCapacityResponse>> => {
...
export const fetchCleaningStation = async (payload: ICleaningStationPayload): Promise<IResponse<ICleaningStationResponse>> => {
