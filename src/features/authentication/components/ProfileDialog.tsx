                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs font-normal">{t("profilePictureLimit")}</span>
                        </div>
                    </div>
                    {isEditing && (
                        <>
                            ...
                            >
                                {updateProfileImageMutation.isPending ? <Loader2 className="animate-spin"/> : <Camera/>}
                    ...
                    <form className="flex flex-col my-6 gap-6">
                        ...
                        <div className="flex items-center justify-between gap-8">
                            {isEditing ? (
                                ...
                                <>
                                    <div
                                        className="w-full bg-muted px-4 py-2 rounded-xl">{profile?.firstname || "—"}</div>
                                    <div
                                        className="w-full bg-muted px-4 py-2 rounded-xl">{profile?.lastname || "—"}</div>
                                </>
                            )}
                        </div>
                ...
                <DialogFooter className="flex-row justify-between sm:justify-between">
                    ...
                    {isEditing ? (
                        <div className="flex gap-4">
                            ...
                            <Button type="button" className="bg-button-accent text-primary-foreground rounded-xl"
                                    onClick={() => onSubmit()}>
