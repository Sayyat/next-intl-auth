...
export const EmailSentDialog: React.FC<IEmailSentDialogProps> = ({open, setCurrentModal}) => {
    const t = useTranslations("features.authentication.components.EmailSentDialog");
        ...
        <Dialog open={open} onOpenChange={() => setCurrentModal(undefined)}>
            ...
            >
                <div className="flex flex-col p-8 gap-8 items-center justify-center text-center">
                    <Mail style={{width: "8rem", height: "8rem"}} className="text-button"/>
